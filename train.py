...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = '../input/faster-rcnn-weights/voc_weights_vgg.pth'
    # ------------------------------------------------------#
    #   输入的shape大小
    # ------------------------------------------------------#
    input_shape = [600, 600]
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    train_annotation_path = '../input/faster-rcnn-weights/2007_train.txt'
    val_annotation_path = '../input/faster-rcnn-weights/2007_val.txt'
